from NE_discrete import all_paths_without_loops, update_edge_flow, calculate_all_latencies
import copy
...
def calculate_nash_flow(G, start_node, stop_node, max_iter=100000, delta = 0.5, lr = 1 - 1e-3, eps=1e-6, verbose=False):
    """
